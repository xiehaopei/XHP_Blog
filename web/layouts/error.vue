<!--
 * @Author: Haopei Xie
 * @Date: 2021-05-17 21:42:44
 * @LastEditTime: 2021-05-17 22:41:25
 * @LastEditors: Haopei Xie
 * @Description: 404 page
 * @FilePath: \We-artsf:\web\XHP_Blog\web\layouts\error.vue
 * 
-->
<template>
  <div class="container">
      ...
      <section class="error">
        ...
        <div class="error__content">
          <div class="error__message message">
            ...
            <p
              class="message__text"
            >We're sorry, the page you were looking for isn't found here. The link you followed may either be broken or no longer exists. Please try again, or take a look at our.</p>
          </div>
...
.top-header:before {
  background-image: url(/image/404/header-footer-gradient-bg.png);
}
.top-header:before {
  content: '';
  display: block;
